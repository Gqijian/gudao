...
public class BuyerServiceImpl implements BuyerService{
    ...
    @Override
    public OrderDTO findOrderOne(String openId, Long orderNum) {
        User user = userMapper.selectUserByOpenId(openId);
        Map<String, Object> map = new HashMap<>();
        map.put("userId", user.getUserId());
        map.put("orderNum",orderNum);
        Order order = orderMapper.selectOrderOne(map);
        List<OrderDetail> orderDetails = orderDetailMapper.selectOrderDetailsByNum(orderNum.toString());
    ...
    @Override
    public OrderDTO cancelOrder(String openId, Long orderNum) {
        Order order = orderMapper.selectOrderByNum(orderNum.toString());
