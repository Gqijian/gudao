...
<form id="ff" method="post">
    <table>
        ...
        <tr>
            <td><span>姓名：</span></td>
            <td>
                <input style="width: 250px"  name="realName" id="realName" type="text" required="true"/>
            </td>
        </tr>
        <tr>
            <td><span>性别：</span></td>
            <td>
                <input style="width: 250px" type="text" id="sex" name="sex" required="true"/>
            </td>
        </tr>
        <tr>
            <td><span>密码：</span></td>
        ...
        <tr>
            ...
            <td>
                <input type="text" style="width: 250px" id="cellPhoneNum" name="cellPhoneNum"/>
            </td>
        </tr>
        <tr>
            <td><span>qq号：</span></td>
            <td>
                <input type="text" style="width: 250px"  id="qq" name="qq"/>
            </td>
        </tr>
        <tr>
            <td><span>邮箱：</span></td>
            <td>
                <input type="text" style="width: 250px"  id="email" name="email"/>
            </td>
        </tr>
        <tr>
    ...
    <div id="dlg-buttons" style="margin-bottom:10px;">
        ...
        <a style="margin-left:105px;" href="javascript:closeDialog()" class="easyui-linkbutton" iconCls="icon-cancel" >关闭</a>
    </div>
</form>
