    ...
    <form id="ff" method="post" enctype="multipart/form-data">
        <table>
            ...
            <tr>
                ...
                <td>
                    <select id="cc" class="easyui-combobox" name="dept" style="width:250px;">
            ...
            <tr>
                ...
                <td>
                    <input style="width: 250px" class="easyui-textbox"  name="productPrice" id="product_price" type="text" required="true"/>
                </td>
            </tr>
            <tr>
                <td><span>成本价(<font color="red">*元</font>)：</span></td>
                <td>
                    <input style="width: 250px" class="easyui-textbox" type="text" id="cost" name="cost" required="true"/>
                </td>
            </tr>
            <tr>
                <td><span>重量(<font color="red">*g</font>)：</span></td>
                <td>
                    <input style="width: 250px" class="easyui-textbox" class="easyui-numberbox" type="text" id="weight" name="weight" required="true"/>
                </td>
            </tr>
            <tr>
                <td><span>商品图片1：</span></td>
                <td><img id="img1" src="" width=100 height=70/>
                    <input type="file" style="width: 250px" class="file" id="imgfile1" name="files"/>
        ...
        <br>
        <br>
        <div id="dlg-buttons" class="dialog-button" style="bottom:auto;">
