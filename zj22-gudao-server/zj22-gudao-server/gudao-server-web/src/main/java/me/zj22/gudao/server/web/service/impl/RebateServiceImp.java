...
public class RebateServiceImp implements RebateService {
    ...
    @Override
    public Integer freeze(Rebate rebate) {
        return rebateWrapperMapper.freeze(rebate);
    }

    @Override
    public Integer nofreeze(Rebate rebate) {
        return rebateWrapperMapper.nofreeze(rebate);
    }
}
