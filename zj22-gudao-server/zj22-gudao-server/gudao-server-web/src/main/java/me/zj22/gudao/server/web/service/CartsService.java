...
public interface CartsService {
   ...
   String deleteCartItemId(Integer productId,HttpServletRequest request, HttpServletResponse response);

   String deleteCartItemId(String[] productId,HttpServletRequest request, HttpServletResponse response);
}
