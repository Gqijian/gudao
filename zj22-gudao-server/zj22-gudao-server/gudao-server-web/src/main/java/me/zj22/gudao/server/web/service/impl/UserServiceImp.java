...
public class UserServiceImp implements UserSerivce {
    ...
    @Override
    public Page<User> findUserListOrder(Page<User> page) {
        page.setTotalRecord(userWrapperMapper.findCountOrder());
        page.setList(userWrapperMapper.findPageListOrder(page));
        return page;
    }

    @Override
    public User selectByOpenId(String openId) {
        User user = userWrapperMapper.selectByOpenId(openId);
        return user;
    }
}
